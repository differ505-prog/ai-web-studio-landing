...
## 3. 核心流程
築時管理者登入內部工作面板後，先建立案件，再從案件進入合約工作台，使用築時數位標準模板生成合約。系統產生專屬簽署連結後，管理者將連結傳給客戶。客戶在手機上開啟簽署頁，閱讀合約內容、填寫簽署資訊並完成手寫簽名。系統保存已簽版本與簽署證據，內部工作面板同步更新合約狀態。

```mermaid
flowchart TD
    A["築時管理者登入工作面板"] --> B["建立或選擇案件"]
    B --> C["在合約工作台套用模板並編輯合約"]
    C --> D["產生專屬簽署連結"]
    D --> E["將連結傳送給客戶"]
    E --> F["客戶以手機開啟簽署頁"]
